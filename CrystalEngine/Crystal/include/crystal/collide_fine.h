#pragma once
#include "contact.h"
//Tags to mark different colliders
#define BOX_TAG 1
#define SPHERE_TAG 2
#define PLANE_TAG 3
...
namespace crystal {
	...
	*/
	...
	public:
		...
		*/
		...
		int getTag() const { return SPHERE_TAG; };
	};

	/**
	* The plane is not a primitive: it doesn't represent another
	* rigid body. But I made it extend primitive class so that it can be handled together with other colliders
	* It is used for contacts with the immovable
	* world geometry.
	* 
	*/
	...
	public:
		...
		*/
		...
		int getTag() const { return PLANE_TAG; };
	};
	...
	*/
	...
	public:
		...
		*/
		...
		int getTag() const { return BOX_TAG; };
	};
	...
	*/
	...
	public:
		...
		//Call the right methods according to the params' tags
		static unsigned primitiveCollide(
