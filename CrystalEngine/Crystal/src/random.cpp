...
real Random::getRandom(real max)
{
	real number = ((real)rand()) / ((real)RAND_MAX) * max;
	if (getRandomBool()) number = -number;
	return number;
}
...
real Random::getRandom(real min, real max)
{
